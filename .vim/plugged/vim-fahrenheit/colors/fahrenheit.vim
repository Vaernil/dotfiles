...
if &t_Co >= 256 || has("gui_running")
    hi Normal ctermbg=0 ctermfg=7 cterm=NONE guibg=#000000 guifg=#ffffff gui=NONE
    set background=dark
    ...
    hi Special ctermbg=bg ctermfg=10 cterm=NONE guibg=bg guifg=#ffaf5f gui=NONE
    hi Statement ctermbg=bg ctermfg=9 cterm=NONE guibg=bg guifg=#d75f00 gui=NONE
    hi String ctermbg=bg ctermfg=1 cterm=NONE guibg=bg guifg=#d7af87 gui=NONE
	...
	hi TabLine ctermbg=bg ctermfg=1 cterm=NONE guibg=bg guifg=#874B5F gui=NONE
	hi TabLineFill ctermbg=8 ctermfg=7 cterm=NONE guibg=#262626 guifg=#ffffff gui=NONE
	hi TabLineSel ctermbg=bg ctermfg=1 cterm=NONE guibg=bg guifg=#ffd75f gui=NONE
    hi Title ctermbg=bg ctermfg=2 cterm=bold guibg=bg guifg=#ffffd7 gui=bold
    hi CursorLine ctermbg=bg ctermfg=NONE cterm=NONE guibg=#262626 guifg=NONE gui=NONE
    hi LineNr ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#af875f gui=NONE
    hi CursorLineNr ctermbg=bg ctermfg=11 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi qfLineNr ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#874B5F gui=NONE
    hi helpLeadBlank ctermbg=bg ctermfg=7 cterm=NONE guibg=bg guifg=#ffffff gui=NONE
    ...
    hi PmenuThumb ctermbg=bg ctermfg=7 cterm=NONE guibg=bg guifg=#ffffff gui=NONE
    hi FoldColumn ctermbg=bg ctermfg=8 cterm=NONE guibg=bg guifg=#262626 gui=NONE
    hi Folded ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#874B5F gui=NONE
    hi WildMenu ctermbg=bg ctermfg=1 cterm=NONE guibg=bg guifg=#ffd75f gui=NONE
    hi SpecialKey ctermbg=bg ctermfg=6 cterm=NONE guibg=bg guifg=#5f87af gui=NONE
    hi DiffAdd ctermbg=8 ctermfg=230 cterm=NONE guibg=#262626 guifg=#ffffd7 gui=NONE
    ...
    hi SpellCap ctermbg=NONE ctermfg=1 cterm=NONE guibg=NONE guifg=#ffd75f gui=NONE guisp=#ffd75f
    hi SpellLocal ctermbg=NONE ctermfg=88 cterm=NONE guibg=NONE guifg=#870000 gui=NONE guisp=#870000
    hi SpellRare ctermbg=NONE ctermfg=1 cterm=NONE guibg=NONE guifg=#d7af87 gui=NONE guisp=#d7af87
    hi ColorColumn ctermbg=bg ctermfg=8 cterm=NONE guibg=bg guifg=#262626 gui=NONE
    ...
    hi Function ctermbg=bg ctermfg=14 cterm=NONE guibg=bg guifg=#ffd787 gui=NONE
    hi Operator ctermbg=bg ctermfg=5 cterm=NONE guibg=bg guifg=#d7875f gui=NONE
    hi Delimiter ctermbg=bg ctermfg=5 cterm=NONE guibg=bg guifg=#d7875f gui=NONE
    hi Boolean ctermbg=bg ctermfg=6 cterm=NONE guibg=bg guifg=#5f87af gui=NONE
    hi VimIsCommand ctermbg=bg ctermfg=5 cterm=NONE guibg=bg guifg=#d7875f gui=NONE
    hi VimFunction ctermbg=bg ctermfg=7 cterm=bold guibg=bg guifg=#ffffff gui=bold
    hi! link VimFuncKey VimCommand
    hi! link VimSubstPat VimString
    hi VimSubstRep4 ctermbg=8 ctermfg=1 cterm=NONE guibg=#262626 guifg=#d7af87 gui=NONE
    hi VimMapLhs ctermbg=8 ctermfg=7 cterm=NONE guibg=#262626 guifg=#ffffff gui=NONE
    hi javaScriptObjectKey ctermbg=bg ctermfg=10 cterm=NONE guibg=bg guifg=#ffaf5f gui=NONE
    hi javaScriptFunctionKey ctermbg=bg ctermfg=88 cterm=NONE guibg=bg guifg=#870000 gui=NONE
    hi htmlItalic ctermbg=bg ctermfg=5 cterm=NONE guibg=bg guifg=#d7875f gui=NONE
    hi markdownLinkTextDelimiter ctermbg=bg ctermfg=5 cterm=NONE guibg=bg guifg=#d7875f gui=NONE
    hi markdownLinkDelimiter ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#874B5F gui=NONE
    hi markdownUrl ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#874B5F gui=NONE
    hi markdownCodeBlock ctermbg=bg ctermfg=1 cterm=NONE guibg=bg guifg=#d7af87 gui=NONE
    hi markdownCode ctermbg=bg ctermfg=1 cterm=NONE guibg=bg guifg=#d7af87 gui=NONE
    hi manOptionDesc ctermbg=bg ctermfg=1 cterm=NONE guibg=bg guifg=#ffd75f gui=NONE
    hi manLongOptionDesc ctermbg=bg ctermfg=10 cterm=NONE guibg=bg guifg=#ffaf5f gui=NONE
    hi CtrlPNoEntries ctermbg=bg ctermfg=88 cterm=NONE guibg=bg guifg=#870000 gui=NONE
    hi CtrlPMatch ctermbg=bg ctermfg=1 cterm=NONE guibg=bg guifg=#ffd75f gui=NONE
    hi CtrlPLinePre ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#874B5F gui=NONE
    hi CtrlPPrtBase ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#874B5F gui=NONE
    hi CtrlPPrtText ctermbg=bg ctermfg=7 cterm=NONE guibg=bg guifg=#ffffff gui=NONE
    hi CtrlPPtrCursor ctermbg=bg ctermfg=9 cterm=NONE guibg=bg guifg=#d75f00 gui=NONE
    hi CtrlPBufferInd ctermbg=bg ctermfg=11 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi CtrlPBufferVis ctermbg=bg ctermfg=10 cterm=NONE guibg=bg guifg=#ffaf5f gui=NONE
    hi CtrlPBufferNr ctermbg=bg ctermfg=6 cterm=NONE guibg=bg guifg=#5f87af gui=NONE
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi Todo ctermbg=5  ctermfg=white cterm=bold
...
" Generated with RNB (https://gist.github.com/romainl/5cd2f4ec14805f49eca)
