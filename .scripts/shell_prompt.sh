...
function __promptline {
  ...
  # 38 5 colornumber of bg 48 5
  # ive spent 2 days trying to approximate colors
  # instead of just using the 16 that i set by myself, talk about facepalm
  ...
  # hostname 235 is closest to 2d2d2d of my grey scheme
  local a_fg="${wrap}38;5;235${end_wrap}"
  local a_bg="${wrap}48;5;1${end_wrap}" # 203 or 167
  ...
  local warn_bg="${wrap}48;5;14${end_wrap}"
  local warn_sep_fg="${wrap}38;5;14${end_wrap}"
  # 
